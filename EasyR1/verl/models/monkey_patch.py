...
def apply_ulysses_patch(model_type: str) -> None:
    if model_type in ("llama", "gemma", "gemma2", "mistral", "qwen2"):
    ...
    elif model_type in ("qwen2_vl", "qwen2_5_vl", "xyqvl"):
        ...
        from mirage.XYQVL.modeling_qwen2_5_vl import XYQ_VLFlashAttention2
        XYQ_VLFlashAttention2.forward = qwen2_vl_attn_forward
    else:
