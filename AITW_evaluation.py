...
data_path = "/data/user/yxu916/zhouxurui/GUIAgent-R1/data_process/aitw/test_data.json"
...
def get_image_info(image_path, min_pixel=512 * 28 * 28, max_pixel=512 * 28 * 28):
...
output_dir = os.path.join(
    '/data/user/yxu916/zhouxurui/GUIAgent-R1/AITW_eval_results',
