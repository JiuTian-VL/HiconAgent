...
class XYQVLVisionConfig(PretrainedConfig):
    model_type = "xyqvl"
...
class XYQVLConfig(PretrainedConfig):
    r"""
    ...
    model_type = "xyqvl"
    sub_configs = {"vision_config": XYQVLVisionConfig}
...
AutoConfig.register("xyqvl", XYQVLConfig)
__all__ = ["XYQVLConfig"]
