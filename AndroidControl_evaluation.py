...
# data_path = '/data7/Users/zxr/zhouxurui/GUI-dataset/Autogen/2_data_for_check/android_control_reward_model_input_validation_language_realcase.json'
## base GRPO prompt
...
data_path = "/data/user/yxu916/zhouxurui/GUI-dataset/AndroidControl/Qwen2-5VL-RL/RL_sequence_low_level_4A_with_finish_train_700_history_2images_test.json"
processor = AutoProcessor.from_pretrained("/data/user/yxu916/zhouxurui/Qwen2_5VL-modify/Qwen2_5VL")

with open(data_path, 'r') as file:
    all_data = json.load(file)[0:2495]
...
parser.add_argument('--model_path', type=str, default="/data/user/yxu916/zhouxurui/GUIAgent-R1/checkpoints/MirageR1/h100_baseline_AMEX/global_step_414/actor/huggingface",
                    help='The path where the model is loaded from')
parser.add_argument('--step_num', type=str, default="384",
                    help='The path where the model is loaded from')
...
# model_path = "/data/user/yxu916/zhouxurui/HiconAgent-R1-goat/checkpoints/MirageR1/AMEX_dynamic_reward_n_8_3his_sampling_group_supply/global_step_414/actor/huggingface"
# step_num = "384"
device = 'cuda'
...
output_dir = os.path.join(
    '/data/user/yxu916/zhouxurui/GUIAgent-R1/eval_results',
    model_path.split('/')[-4] + step_num
)
os.makedirs(output_dir, exist_ok=True)  # 创建目录

output_file = os.path.join(output_dir, '0.json')
